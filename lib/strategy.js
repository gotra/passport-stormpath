 ...
 *
 * Options:
 *  - `apiKeyId`        Your Stormpath API key ID.
 *  - `apiKeySecret`    Your Stormpath API key secret.
 *  - `appHref`         Your Stormpath Application href.
 *  - `usernameField`   The HTML form field to retrieve the username from.  Defaults to 'username'.
 *  - `passwordField`   The HTML form field to retrieve the password from.  Defaults to 'password'.
 *
 * Examples:
 *
